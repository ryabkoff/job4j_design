...
select * 
    from employees as em 
    right join departments as dep on em.department_id = dep.id;

select * 
    from employees as em 
    full join departments as dep on em.department_id = dep.id;
...
select em.name, em.id, dep.name, dep.id 
    from employees as em 
    left join departments as dep on em.department_id = dep.id;
...
select teens1.name, teens2.name 
